...
export const ROUTING_CORPUS: RoutingCase[] = [
  ...
  plain("that's not right anymore: I work from home now", 'correct'),
  plain('update my remembered diet: I am vegan now', 'correct'),
  plain('correct the memory that my appointment is Wednesday; it is Thursday', 'correct'),
